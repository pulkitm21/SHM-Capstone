...
FAULT_CODE_MAP: dict[int, FaultDefinition] = {
    ...
    4: FaultDefinition( "MQTT disconnected", "mqtt", "mqtt_connection", 3, "active", "node"),
    5: FaultDefinition( "MQTT reconnected", "mqtt", "mqtt_connection", 1, "resolved", "node"),
    6: FaultDefinition( "MQTT publish failed", "mqtt", "mqtt_publish", 2, "active", "node"),
